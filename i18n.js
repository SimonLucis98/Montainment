...
const i18n = {
  ...
  messages: {
    ...
    en: {
      ...
      'index.feature_story_desc': 'Choose a story, and the workshop will take you on a journey.',
      ...
      'quiz.desc': 'First select the category, then the subject, difficulty, and finally a paper.',
      'quiz.score': 'Score:',
      'quiz.next_btn': 'Next →',
      'quiz.select_category': '📂 Select Category',
      'quiz.select_category_prompt': 'Select a learning category',
      'quiz.back_to_category': 'Back to categories',
      'quiz.select_subject': 'Select Subject',
      'quiz.select_subject_prompt': 'Select the subject to learn',
      'quiz.back_to_subject': 'Back to subjects',
      ...
      'quiz.no_data': 'No data available',
      'quiz.no_data_prompt': 'Please add categories and subjects in the admin panel and export JSON.',
      ...
      'immersive.hot': '🔥 Hot',
      'immersive.categories': '🏷️ Categories',
    ...
    zh: {
      ...
      'index.feature_story_desc': '选择一个故事，工坊带你探索一段属于你的故事。',
      ...
      'quiz.desc': '先选择类别，再选择科目，然后难度，最后挑选试卷。',
      'quiz.score': '得分：',
      'quiz.next_btn': '下一题 →',
      'quiz.select_category': '📂 选择类别',
      'quiz.select_category_prompt': '选择学习类别',
      'quiz.back_to_category': '返回类别',
      'quiz.select_subject': '选择科目',
      'quiz.select_subject_prompt': '选择要学习的科目',
      'quiz.back_to_subject': '返回科目',
      ...
      'quiz.no_data': '暂无数据',
      'quiz.no_data_prompt': '请在后台添加类别和科目并导出 JSON。',
